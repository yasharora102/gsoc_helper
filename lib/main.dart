...
import 'package:gsoc_helper/dataModel.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //       children: [TechStack(), Organisations()],
    //     ));
        ...
        home: DefaultTabController(
            ...
            child: Scaffold(
                appBar: AppBar(
                  ...
                  bottom: const TabBar(
                    tabs: [
                      Tab(icon: Icon(Icons.format_list_bulleted_rounded,color: Colors.white,)),
                      Tab(icon: Icon(Icons.groups_rounded,color: Colors.white)),
                    ],
                  ),
